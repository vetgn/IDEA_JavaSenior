 ...
 * Lambda表达式的使用
 *
 * 1.举例:(01, 02) -> Integer. compare (o1, o2);一
 * 2.格式:
 *       -> :Lambda操作符 或 箭头操作符
...
public class LambdaTest1 {
    ...
    @Test
    public void test3() {
        Consumer<String> con1 = (String s) -> System.out.println(s);//由于Consumer后面标注了String所以能推断出都是String
        con1.accept("hhh");
    ...
    //语法格式五: Lambda 需要两个或以上的参数,多条执行语句,并且可以有返回值@Test
    @Test
    public void test6() {
